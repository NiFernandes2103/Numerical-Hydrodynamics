...
def getXFlux(D_P, D_M, Sx_P, Sx_M, tau_P, tau_M, gamma, P0, Eos=polytrope):
    ...
    rho_P,vx_P,eps_P = getPrimitive(D_P,Sx_P,tau_P, gamma, P0, 0.1*np.ones(D_P.shape), 100, Eos)
    rho_M,vx_M,eps_M = getPrimitive(D_M,Sx_M,tau_M, gamma, P0, 0.1*np.ones(D_P.shape), 100, Eos)
